...
$checks = [
	...
	'Organizer category counters render recursive server totals with localized singular and plural labels' => str_contains( (string) $organizer, 'private static function document_counts(' ) && str_contains( (string) $organizer, 'data-cb-docs-document-count' ) && str_contains( (string) $organizer, "_n( '%d document', '%d documents'"),

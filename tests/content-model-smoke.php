...
$checks = [
	...
	'Hierarchy mode moves taxonomy URLs under the Docs namespace' => str_contains( (string) $taxonomies, '$hierarchy ? false' ) && str_contains( (string) $taxonomies, "$base . '/tag'" ),
	...
	'Docs URL structure remains backward-compatible and explicitly opt-in' => str_contains( (string) $settings, "URL_STRUCTURE_SIMPLE = 'simple'" ) && str_contains( (string) $settings, "URL_STRUCTURE_HIERARCHY = 'category_hierarchy'" ) && str_contains( (string) $settings, 'DEFAULT_URL_STRUCTURE = self::URL_STRUCTURE_SIMPLE' ),
